		...
		?>
			<article class="fs-row <?php if (is_home() && $i === 0) echo 'listing_article_first' ?>">
				...
				<div class="fs-cell fs-lg-4">
					...
					<?php endif; ?>
					<div><?php echo get_the_term_list($post->ID, "disciplines"); // Display the categories this post belongs to, as links ?></div>
				...
				<div class="fs-cell fs-lg-8">
					<?php
						...
						if ( has_post_thumbnail() ) {
							the_post_thumbnail( 'medium' , array("class" => "listing_article_image") );
						}
					?>
